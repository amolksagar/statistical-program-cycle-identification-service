...
public class CentralisedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	 ...
	 * @return
	 */
	@ExceptionHandler(StatisticalProgramCycleNotFoundException.class)
	public final ResponseEntity<Object> handleUserNotFoundExceptions(StatisticalProgramCycleNotFoundException ex,
			WebRequest webReq) {
		ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), ex.getMessage(),
				webReq.getDescription(false));
